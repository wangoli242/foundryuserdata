...
import { n as i, t as a } from "./lcp_manifest-CqYDDPe3.mjs";
//#region node_modules/@massif/ssmr-data/lib/frames.json
var o = /* @__PURE__ */ n({ default: () => s }), s, c = e((() => {
	...
	g = [
		{
			...
			type: "System",
			sp: 2,
			tags: [{ id: "tg_reaction" }, { id: "tg_exotic" }],
			source: "EXOTIC",
		...
		},
		{
			...
			type: "System",
			sp: 2,
			tags: [{ id: "tg_exotic" }, { id: "tg_free_action" }],
			source: "EXOTIC",
		...
		},
		{
			...
			type: "System",
			sp: 2,
			tags: [{ id: "tg_quick_action" }, { id: "tg_exotic" }],
			source: "EXOTIC",
	...
	n.exports = {
		...
		frames: (c(), t(o).default),
		pilot_gear: (d(), t(l).default),
		reserves: (m(), t(f).default),
		systems: (_(), t(h).default),
		talents: (b(), t(v).default),
		weapons: (C(), t(x).default)
	};
}));
//#endregion
export default w();

//# sourceMappingURL=ssmr-data-CA4hSx1D.mjs.map