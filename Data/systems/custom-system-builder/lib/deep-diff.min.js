!(function (e, t) {
    var n = (function (e) {
        ...
        function k(e, t) {
            k.super_.call(this, 'N', e), Object.defineProperty(this, 'rhs', { value: t, enumerable: !0 });
        }
        function j(e, t) {
            j.super_.call(this, 'D', e), Object.defineProperty(this, 'lhs', { value: t, enumerable: !0 });
        }
        function O(e, t, n) {
            ...
            if ('object' === n) {
                for (var a in e)
                    if (e.hasOwnProperty(a)) {
                        var i = '[ type: object, key: ' + a + ', value hash: ' + x(e[a]) + ']';
                        t += u(i);
                    }
                return t;
            }
        ...
        function A(e, t, n, r, a, i, l, f) {
            ...
            'regexp' === w(e) && 'regexp' === w(t) && ((e = e.toString()), (t = t.toString()));
            var h,
                s,
                p,
                c,
            ...
            if (!b && g) n.push(new k(u, t));
                ...
                if (c) e !== t && n.push(new D(u, e, t));
                    ...
                    if ((l.push({ lhs: e, rhs: t }), Array.isArray(e))) {
                        ...
                        for (h = 0; h < m.length; ++h) (p = m[h]) && A(void 0, t[p], n, r, u, p, l, f);
                    }
                    l.length = l.length - 1;
                }
            } else e !== t && (('number' === d && isNaN(e) && isNaN(t)) || n.push(new D(u, e, t)));
        }
        function o(e, t, n, r, a) {
            var i = [];
            if ((A(e, t, i, r, null, null, null, a), n)) for (var l = 0; l < i.length; ++l) n(i[l]);
            return i;
        }
        function r(e, t, n, r) {
            var a = r
        ...
        function a(e, t, n) {
            if ((void 0 === n && t && ~l.indexOf(t.kind) && (n = t), e && n && n.kind)) {
                for (var r = e, a = -1, i = n.path ? n.path.length - 1 : 0; ++a < i; )
                    void 0 === r[n.path[a]] &&
                        (r[n.path[a]] = void 0 !== n.path[a + 1] && 'number' == typeof n.path[a + 1] ? [] : {}),
                        (r = r[n.path[a]]);
                switch (n.kind) {
                    case 'A':
    ...
    else if ('object' == typeof exports || ('object' == typeof navigator && navigator.product.match(/ReactNative/i)))
        module.exports = n;
    else {
        var r = e.DeepDiff;
